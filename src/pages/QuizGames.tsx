  ...
  const joinRoom = async () => {
    ...
    try {
      ...
      if (room.status !== 'waiting') {
        throw new Error('Esta sala ya comenzó o terminó.')
      }
      ...
      if (playerError) {
        if (playerError.code === '23505') {
          navigate(`/juegos/preguntas/sala/${room.code}`);
          return
        }
        throw playerError
      }
    ...
    <Fragment>
      <main className='min-h-screen bg-zinc-50 px-4 py-10'>
        <div className='mx-auto max-w-3xl'>
          <Link to='/juegos' className='mb-8 inline-flex items-center gap-2 text-sm font-medium text-zinc-600 hover:text-zinc-900'>
          ...
          {mode === 'menu' && (
            <div className='rounded-3xl bg-white p-8 shadow-sm sm:p-12'>
              <div className='text-center'>
                ...
                <h1 className='mt-6 text-4xl font-bold'>Juego de Preguntas</h1>
              ...
              <div className='mt-10 grid gap-4 sm:grid-cols-2'>
                <button
                  ...
                  <h2 className='mt-5 text-xl font-bold'>Crear sala</h2>
                ...
                <button
                  ...
                  <h2 className='mt-5 text-xl font-bold'>Unirse a sala</h2>
          ...
          {mode === 'create' && (
            <div className='rounded-3xl bg-white p-8 shadow-sm'>
              ...
              <p className='mt-2 text-zinc-600'>Serás el anfitrión de la partida.</p>
              {error && (
          ...
          {mode === 'join' && (
            <div className='rounded-3xl bg-white p-8 shadow-sm'>
              ...
              <p className='mt-2 text-zinc-600'>Escribe el código de 6 caracteres.</p>
              {error && (
                <div className='mt-6 rounded-xl bg-red-50 p-4 text-sm text-red-700'>
                  {error}
                </div>
