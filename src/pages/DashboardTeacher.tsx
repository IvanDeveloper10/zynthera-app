      ...
      <main className='min-h-screen bg-zinc-50 p-4 sm:p-8'>
        <div className='mx-auto max-w-7xl'>
          <div className='flex flex-col justify-between gap-6 md:flex-row md:items-center'>
            <div>
              <p className='mb-2 text-sm font-medium text-zinc-500'>Panel del profesor</p>
          ...
          <div className='mt-8 grid gap-4 md:grid-cols-3'>
            <div className='rounded-2xl border bg-white p-6 shadow-sm'>
              ...
              <p className='mt-2 truncate font-medium text-zinc-900'>{user?.email}</p>
            </div>
            <div className='rounded-2xl border bg-white p-6 shadow-sm'>
          ...
          <section className='mt-10'>
            <div className='mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-end'>
              <div>
                <h2 className='text-2xl font-bold text-zinc-950'>Mis cursos</h2>
            ...
            {coursesLoading && (
              <div className='flex min-h-64 items-center justify-center rounded-2xl border bg-white'>
                <div className='text-center'>
                  ...
                  <p className='mt-3 text-sm text-zinc-500'>Cargando tus cursos...</p>
                </div>
              </div>
            )}
            {!coursesLoading &&
              ...
              courses.length === 0 && (
                <div className='flex min-h-64 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-200 bg-white px-6 text-center'>
                  ...
                  <p className='mt-4 font-semibold text-zinc-700'>Todavía no tienes cursos</p>
