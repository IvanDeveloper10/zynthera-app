        ...
        <div className='w-full flex flex-wrap justify-around items-start px-10 gap-10'>
          <div className='w-96 flex flex-col justify-center items-center text-center'>
            <video autoPlay loop muted playsInline width={100}>
              <source src='https://smxxozttrwhkgtpnfvbx.supabase.co/storage/v1/object/public/home-resources/mind-icon-animate.mp4' type='video/mp4' />
            </video>
          ...
          <div className='w-96 flex flex-col justify-center items-center text-center'>
            <video autoPlay loop muted playsInline width={100}>
              <source src='https://smxxozttrwhkgtpnfvbx.supabase.co/storage/v1/object/public/home-resources/square-icon-animate.mp4' type='video/mp4' />
            </video>
          ...
          <div className='w-96 flex flex-col justify-center items-center text-center'>
            <video autoPlay loop muted playsInline width={100}>
              <source src='https://smxxozttrwhkgtpnfvbx.supabase.co/storage/v1/object/public/home-resources/science-icon-animate.mp4' type='video/mp4' />
            </video>
